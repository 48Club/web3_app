...
const Account = () => {
    ...
    const { searchText, searchTextHash, setSearchText, setResult, setLoading } = useInscriptionsSearchState()
    ...
    const search = async (text:string=searchText) => {
        setLoading(true)
        // const hashList = AccountToken.map(hash => hash.tick_hash);
